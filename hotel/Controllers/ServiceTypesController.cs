...
namespace hotel.Controllers
{
    public class ServiceTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "serviceTypeID,serviceType1")] ServiceType serviceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "serviceTypeID,serviceType1")] ServiceType serviceType)
        {
            if (ModelState.IsValid)
            {
